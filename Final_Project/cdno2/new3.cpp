...
double Eval_Ov(Shell &sh1, Shell & sh2)
{
  ...
  double overlap_tot=Overlap_onedim(Ra(0)/0.52917721067121, Rb(0)/0.52917721067121, alphaa, alphab, la(0), lb(0)) 
  * Overlap_onedim(Ra(1)/0.52917721067121, Rb(1)/0.52917721067121, alphaa, alphab, la(1), lb(1)) 
  * Overlap_onedim(Ra(2)/0.52917721067121, Rb(2)/0.52917721067121, alphaa, alphab, la(2),lb(2));
    ...
    for(int k=0;k<=2;k++)
    {
      for(int l=0;l<=2;l++)
      {
        for(int m=0;m<=2;m++)
        {
          ...
          R_ab_dist=R_ab_dist/0.52917721067121;
...
double scf_real(int n_atoms,int p,int q,arma::mat h_mu_nu,arma::mat g_mu_nu,Shell **arr1,Shell**arr3,Shell**arr2)
{
  double energy_cdno2=-430.129944;
...
//C1-2s
  ...
  Shell* arr2[14]={shell_arr_1,shell_arr_2,shell_arr_3,shell_arr_4,shell_arr_5,shell_arr_6,shell_arr_7,shell_arr_8,shell_arr_9,shell_arr_10,shell_arr_11,shell_arr_12,shell_arr_13,shell_arr_14};
...
//gamma
  arma::mat gamma(8,8,arma::fill::zeros);
  Shell *arr1[8]={shell_arr_1,shell_arr_2,shell_arr_3,shell_arr_4,shell_arr_5,shell_arr_6,shell_arr_7,shell_arr_8};
  create_gamma_mat(gamma,arr1);
  // gamma.print();
  // cout << "\n\n";


  Shell* arr3[10]={shell_arr_1,shell_arr_1,shell_arr_1,shell_arr_2,shell_arr_2,shell_arr_2,shell_arr_3,shell_arr_4,shell_arr_5,shell_arr_6,shell_arr_7,shell_arr_8};


//gamma3
  arma::mat gamma3_offdiag(12,8,arma::fill::zeros);

//gamma5
  arma::mat gamma5_diag(12,8,arma::fill::zeros);


//gamma3
  arma::mat gamma3(12,8,arma::fill::zeros);
...
//gamma4
  arma::mat gamma4(12,8,arma::fill::zeros);
  create_gamma_diag(gamma4,arr3,arr1);
  // gamma4.print();
  // cout << "\n\n";
...
//hmat
  ...
  arma::mat g_mu_nu(14,14,arma::fill::zeros);

  cout <<scf_real(8,7,7,hmat,g_mu_nu,arr1,arr3,arr2);
  cout << "\n\n";
