...
double scf_real_density(int n_atoms,int p,int q,double tot_eng,arma::mat h_mu_nu,arma::mat g_mu_nu,Shell**arr1,Shell**arr3,Shell**arr2)
{
...
//hmat
  ...
  cout << scf_real_density(8,7,7,-430.129966,hmat,g_mu_nu,arr1,arr3,arr2);
  cout << "\n\n";
