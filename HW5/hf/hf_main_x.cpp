...
//ov - x 
  arma::mat overlap_x(5,5,arma::fill::zeros);
  Shell* arr2[5]={shell_arr,shell_arr_3,shell_arr_4,shell_arr_5,shell_arr_6};
...
//gamma 
  ...
  Shell* arr1[2]={shell_arr,shell_arr_3};
...
//gamma -x
  ...
  Shell* arr3[5]={shell_arr,shell_arr_3,shell_arr_3,shell_arr_3,shell_arr_3};

//gamma3
  arma::mat gamma3(5,2,arma::fill::zeros);
  hcore_sum_not(gamma3,arr3,arr1);
  gamma3.print();
  cout << "\n\n";

//gamma4
  arma::mat gamma4(5,2,arma::fill::zeros);
  create_gamma_diag(gamma4,arr3,arr1);
  gamma4.print();
  cout << "\n\n";

//hmat
  arma::mat hmat(5,5,arma::fill::zeros);
  create_h_core_mat(hmat,gamma3,gamma4,arr2);
  hmat.print();
  cout << "\n\n";


  arma::mat g_mu_nu_(5,5,arma::fill::zeros);
  arma::mat P_a_new=scf_real_density(2,5,2,-742.837312,hmat,g_mu_nu_,arr1,arr3,arr2);
  cout << P_a_new;
  cout << "\n\n";

  arma::mat P_b_new = scf_real_density(2,5,2,-742.837312,hmat,g_mu_nu_,arr1,arr3,arr2);
  cout << P_b_new;
  cout << "\n\n";
...
//   arma::mat pt(2,5,arma::fill::zeros);
...
//   arma::mat pt_(5,5,arma::fill::zeros);
...
// //yab_off
//   arma::mat y_a_b_off_diag_(5,5,arma::fill::zeros);
