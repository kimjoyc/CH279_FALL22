...
//dynamic 
  ...
  //gamma4
    ...
    pt_next_2=create_pt(pt_next_2,P_t_next_2,arr1,arr3);

    arma::mat nextpt_2(10,10,arma::fill::zeros);
    nextpt_2=create_pt2(nextpt_2,P_t_next_2,arr3);

    arma::mat gamma_fun2_next_2(10,4,arma::fill::zeros);
    gamma_fun2_next_2=gamma_ptot_not_a2(gamma_fun2_next_2,pt_next_2,arr3,arr1);

    arma::mat gmat_check_alpha_next_2(10,10,arma::fill::zeros);
    gmat_check_alpha_next_2=g_mat2(gmat_check_alpha_next_2,nextpt_2,gamma_fun2_next_2,gamma4_next_2,P_a_new_next_2,arr2,arr3);

    arma::mat gmat_check_beta_next_2(10,10,arma::fill::zeros);
    gmat_check_beta_next_2=g_mat2(gmat_check_beta_next_2,nextpt_2,gamma_fun2_next_2,gamma4_next_2,P_b_new_next_2,arr2,arr3);
...
//hmat
  ...
  cout <<scf_real(4,5,5,hmat,g_mu_nu,arr1,arr3,arr2);
  cout << "\n\n";
